...
const certsData = [
  {
    org: 'IBM',
    title: 'IBM Enterprise Java Developer & AI Professional',
    issuer: 'IBM Skills Network',
    date: '2024',
    badgeColor: 'from-blue-600 to-indigo-600',
    logo: '🔵',
    skills: ['Java Enterprise', 'Spring Framework', 'RESTful APIs', 'AI Fundamentals'],
    credentialId: 'IBM-CERT-8849201',
  },
  {
    org: 'Google',
    title: 'Google Data Analytics & Machine Learning Foundations',
    issuer: 'Google Career Certificates',
    date: '2023',
    badgeColor: 'from-red-500 via-amber-500 to-emerald-500',
    logo: '🔴',
    skills: ['Python Data Analysis', 'SQL Database Queries', 'Machine Learning Pipelines', 'Data Visualization'],
    credentialId: 'GCC-ML-5520938',
  },
  {
    org: 'Microsoft',
    title: 'Microsoft Certified: Azure AI & Cloud Fundamentals',
    issuer: 'Microsoft Learn',
    date: '2024',
    badgeColor: 'from-cyan-500 to-blue-600',
    logo: '🟦',
    skills: ['Azure AI Services', 'Cloud Architecture', 'Natural Language Processing', 'Computer Vision'],
    credentialId: 'MS-AZAI-1039824',
  },
];
